...
The devcontainer is a Docker container that is used to run the application. It is used to ensure that the application is run in a consistent environment and local development installs all the necessary dependencies.
